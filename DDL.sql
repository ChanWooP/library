...
(
	...
	, LOAN_RETURN_DATE DATETIME NOT NULL
	...
	, LAST_MODIFIED_BY VARCHAR(255)
	, LAST_MODIFIED_DATE DATETIME
	, FOREIGN KEY(LOAN_ISBN) REFERENCES BOOK(BOOK_ISBN)
	, FOREIGN KEY(LOAN_USER) REFERENCES USERS(USER_ID)
) DEFAULT CHARACTER SET UTF8;
...
(
	...
	, LAST_MODIFIED_BY VARCHAR(255)
	, LAST_MODIFIED_DATE DATETIME
	, FOREIGN KEY(RESERVE_ISBN) REFERENCES BOOK(BOOK_ISBN)
	, FOREIGN KEY(RESERVE_USER) REFERENCES USERS(USER_ID)
) DEFAULT CHARACTER SET UTF8;

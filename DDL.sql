...
CREATE INDEX IDX_BOOK_HOPE ON BOOK_HOPE(HOPE_STATUS);
CREATE INDEX IDX_BOOK_HOPE_TITLE ON BOOK_HOPE(HOPE_STATUS, HOPE_TITLE);
CREATE INDEX IDX_BOOK_HOPE_ISBN ON BOOK_HOPE(HOPE_STATUS, HOPE_ISBN);
